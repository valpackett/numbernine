...
int main(int argc, char* argv[]) {
	...
	agent.connect(Gio::DBus::BUS_TYPE_SYSTEM, "org.freedesktop.PolicyKit1.AuthenticationAgent");
	app->hold();
	Glib::signal_idle().connect([&] {
		org::freedesktop::PolicyKit1::Authority::createForBus(
		    ...
		    [=](Glib::RefPtr<Gio::AsyncResult> result) {
			    const auto proxy = org::freedesktop::PolicyKit1::Authority::createForBusFinish(result);
